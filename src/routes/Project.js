  ...
  return (
    <>
      ...
      <TextContainer>
        ...
        <P>
          - 현재 프론트엔드와 스테틱한 데이터로 구성되어있으나 앞으로 Database와
          연결하여 다이나믹한 포트폴리오로 만들 계획입니다.
        </P>
        <P>
          - 재미적 요소를 추가하기 위해 평소 존경하는 개발자 Jongmin Kim님의
          프로젝트에 사용된 물결효과를 프로필 사진에 넣어봤습니다.
        </P>
        <P>
          <a href="https://korea-code.github.io/resume/">Web</a>
          &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <TextContainer>
        ...
        <br />
        <Italic>Environment</Italic>
        <P>- Typescript, Angular, Bootstrap, Express, Mongodb, Ajax</P>
        <Italic>Objective</Italic>
        <P>
        ...
        <Italic>Description</Italic>
        <P>
          -  Express & Mongodb로API를 제작하여, ajax를 통하여 데이터를 다운받아
          동적인 웹을 제작하였습니다.
        </P>
      ...
      <TextContainer>
        ...
        <P>
          - Frontend는 React와 React Native(Expo)를 활용하여 제작 중 이며, 웹은
      ...
      <TextContainer>
        ...
        <Italic>Description</Italic>
        <P>
          - 튜토리얼을 참고하여 웹 게임들을 제작하며 Typescript의 사용법을
          공부하였습니다.
        </P>
        <Italic>Links</Italic>
        <P>
