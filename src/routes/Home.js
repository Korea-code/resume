    ...
    <>
      ...
      <TextContainer>
        ...
        <P>
          ...
          저는 한국에서 대학을 졸업하고 영어를 통해 나의 세상을 넓혀보겠다는
          꿈을 갖고 여자친구와 결혼 후 캐나다로 떠났습니다. 그리고 캐나다에서
          너무 행복하게도 프로그래밍을 배우게 되었습니다. 개발자들, 그리고
          소프트웨어 서비스를 준비하는 회사들은 아주 중요한 임무를 맡고있다고
          생각합니다. 온 세상이 네트워크로 이어져 있는 지금 그 중간 다리를
          어떻게 이을 것이냐를 잘 결정해야하기 때문입니다. 제가 채용공고를 보고
          개인적으로 제일 마음이 갔던 이유는 Presence의 Mission이 지금
          현실에서의 채워져야 할 부분을 너무 잘 바라봤다고 생각했기 때문입니다.
          원격 근무는 코로나로인한 일시적인 현상이 아니라 세계화되어가는
          사회에서 우리 인류가 나아가야 할 방향이며, Presence와 함께 하여 소통
          문제를 해결해 낼 수 있는 World class의 제품을 개발하길 기대합니다.
        </P>
      </TextContainer>
    </>
  );
